...
export async function sendEmailVerification(email: string, code: string) {
  ...
  const textBody = [
    'Welcome to SMSblast!',
    '',
    'Please verify your email address by entering the verification code below in the app.',
    '',
  ...
  const htmlBody = `
    ...
    <p>Please verify your email address by entering the verification code below in the app.</p>
