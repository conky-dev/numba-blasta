...
export default function HistoryPage() {
  return (
    <div className="p-8">
      <h1 className="text-2xl font-semibold text-gray-800 mb-6">SMS History</h1>
        ...
        <div className="p-4 border-b border-gray-200 flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            ...
            <input
              ...
              className="px-3 py-2 border border-gray-300 rounded-md text-sm w-64 focus:ring-2 focus:ring-blue-500 focus:border-transparent"
            />
